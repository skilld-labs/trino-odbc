...
if exist %ODBC% (
	...
	reg add "HKEY_LOCAL_MACHINE\SOFTWARE\ODBC\ODBCINST.INI\Amazon Trino ODBC Driver" /v Driver /t REG_SZ /d %ODBC% /f
	reg add "HKEY_LOCAL_MACHINE\SOFTWARE\ODBC\ODBCINST.INI\Amazon Trino ODBC Driver" /v Setup /t REG_SZ /d %ODBC% /f
