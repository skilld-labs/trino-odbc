...
namespace query {
/**
 * Table privileges query.
 */
class TablePrivilegesQuery : public Query {
 public:
  /**
   * Constructor.
   *
   ...
   */
  TablePrivilegesQuery(diagnostic::DiagnosableAdapter& diag);

  /**
   * Destructor.
   */
  virtual ~TablePrivilegesQuery();
 ...
 private:
  IGNITE_NO_COPY_ASSIGNMENT(TablePrivilegesQuery);
