...
#ifndef _TRINO_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD_STORAGE
#define _TRINO_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD_STORAGE
...
#endif  //_TRINO_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD_STORAGE
