...
#ifndef _TIMESTREAM_ODBC_QUERY_PROCEDURE_COLUMNS_QUERY
#define _TIMESTREAM_ODBC_QUERY_PROCEDURE_COLUMNS_QUERY
...
namespace query {
/**
 * Procedure columns query.
 */
class ProcedureColumnsQuery : public Query {
 public:
  /**
   * Constructor.
   *
   ...
   */
  ProcedureColumnsQuery(diagnostic::DiagnosableAdapter& diag);

  /**
   * Destructor.
   */
  virtual ~ProcedureColumnsQuery();
 ...
 private:
  IGNITE_NO_COPY_ASSIGNMENT(ProcedureColumnsQuery);
...
#endif  //_TIMESTREAM_ODBC_QUERY_PROCEDURE_COLUMNS_QUERY
