...
ODBC_INSTALL_INI="$ODBC_LIB_PATH/trino-odbc-install.ini"

echo "[Amazon Trino ODBC Driver]"            > $ODBC_INSTALL_INI
echo "Description=Amazon Trino ODBC Driver" >> $ODBC_INSTALL_INI
